{
	...
	// TString inpath[nfiles] = {"/data6/ggNtuples/V07_04_14_01/job_spring15_DYJetsToLL_m50_miniAOD.root","/data2/shilpi/CD_25ns/job_DoubleMu_Run2015CD_miniAOD.root", "/data2/shilpi/DY_TnP/ggtree_DYJets_madgraph.root"}; 
