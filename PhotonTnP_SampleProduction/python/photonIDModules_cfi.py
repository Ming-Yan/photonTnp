...
# additional preselected cut, add by PH in 03.01.17
    ...
    if options['PHOTON_InEB']:
        process.goodPhotonsChIso.id_cut           = cms.double(2.0)
        process.goodPhotonsChIso.isGreaterThan    = cms.bool(False)

    else:
        process.goodPhotonsChIso.id_cut           = cms.double(1.5)
        process.goodPhotonsChIso.isGreaterThan    = cms.bool(False)
