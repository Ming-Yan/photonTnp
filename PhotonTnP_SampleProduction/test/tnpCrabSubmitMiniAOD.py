...
mainOutputDir = '/store/user/pwang/0816_2/phys_egamma/tnp/80X/RecoSF/%s' % submitVersion
#mainOutputDir = '/store/pwang/test/phys_egamma/'
...
if __name__ == '__main__':
    ...
    #config.General.requestName  = 'DYToLL_mcAtNLO_v2'
    ...
    config.General.requestName  = 'DYToLL_madgraph_v2'
    ...
    #config.General.requestName  = 'WJets_madgraph_v2'
