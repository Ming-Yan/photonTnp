...
options['PHOTON_CUTS']          = "(abs(-log(tan(superCluster.position.theta/2)))<=2.5) && pt> 10 && ((abs(eta)<1.4442 && hadronicOverEm<0.08 && full5x5_sigmaIetaIeta < 0.015) || (abs(eta)>1.56 && (abs(eta)<2.5 && hadronicOverEm<0.05 && full5x5_sigmaIetaIeta < 0.045)) )" # add by PH in 03.01.17
options['PHOTON_InEB']          = "abs(eta)<1.5"
