...
options['PHOTON_CUTS']          = "(abs(-log(tan(superCluster.position.theta/2)))<=2.5) && pt> 10 && ((abs(eta)<1.4442 && full5x5_sigmaIetaIeta < 0.015) || (abs(eta)>1.56 && (abs(eta)<2.5 && full5x5_sigmaIetaIeta < 0.045)) )"
