...
if __name__ == "__main__":  
    ...
    parser.add_option("", "--failBkgPdf", default="Chebychev::backgroundPass(mass, {cPass1[0,-1,1], cPass2[0,-1,1], cPass3[0,-1,1]})", help="Background PDF for passing probes")
    parser.add_option("", "--passBkgPdf", default="Chebychev::backgroundFail(mass, {cFail1[0,-1,1], cFail2[0,-1,1], cFail3[0,-1,1]})", help="Background PDF for failing probes")
