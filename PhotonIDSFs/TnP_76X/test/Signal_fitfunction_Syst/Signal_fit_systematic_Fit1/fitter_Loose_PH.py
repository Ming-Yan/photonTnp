...
options.register(
    ...
    "/data2/pwang/TnP/76X_v2/TnP_MC_PO.root",
    VarParsing.multiplicity.singleton,
...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[0.999, 0.0,60.0],nP[1.405,0.000,150.000],sigmaP_2[1.000,0.500,20.00])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[3.331,0.00,20.000],alphaF[1.586, 0.0,60.0],nF[5,0.000,30.00],sigmaF_2[1.675,0.100,20.000])",
            ...
            "RooCMSShape::backgroundPass(mass, alphaPass[60.,10.,100.], betaPass[0.001, 0.,0.1], gammaPass[0.1, 0, 1], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[60.,10.,100.], betaFail[0.001, 0.,1.], gammaFail[0.1, 0, 1], peakFail[90.0])",
