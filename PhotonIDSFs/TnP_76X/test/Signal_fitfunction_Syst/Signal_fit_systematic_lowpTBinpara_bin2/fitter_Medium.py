...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[1.944,0.000,50.000],nP[0.490,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[0.094,0.000,50.000],nF[0.758,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            "ZGeneratorLineShape::signalPhy(mass)", 
            "RooCMSShape::backgroundPass(mass, alphaPass[59,59,59], betaPass[0.07, 0.07,0.07], gammaPass[0.05, 0.05, 0.05], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[62.2,62.2,62.2], betaFail[0.065, 0.065,0.065], gammaFail[0.034, 0.034, 0.034], peakFail[90.0])",
