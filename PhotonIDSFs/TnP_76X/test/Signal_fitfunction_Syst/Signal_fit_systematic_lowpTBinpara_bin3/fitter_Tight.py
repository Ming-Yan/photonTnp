...
#import PhysicsTools.TagAndProbe.signalFitFunction.commonFitTight_S as common
...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[2.026,0.000,50.000],nP[0.473,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[1.307,0.000,50.000],nF[0.535,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            "ZGeneratorLineShape::signalPhy(mass)", 
            "RooCMSShape::backgroundPass(mass, alphaPass[57,57,57], betaPass[0.10, 0.10,0.10], gammaPass[0.034, 0.034, 0.034], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[65.2,65.2,65.2], betaFail[0.063, 0.063,0.063], gammaFail[0.021, 0.021, 0.021], peakFail[90.0])",
