...
#import PhysicsTools.TagAndProbe.signalFitFunction.commonFitMVA_S as common
...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[1.877,0.000,50.000],nP[0.567,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[0.038,0.000,50.000],nF[0.229,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            "ZGeneratorLineShape::signalPhy(mass)", 
            "RooCMSShape::backgroundPass(mass, alphaPass[61.,61.,61.], betaPass[0.06, 0.06,0.06], gammaPass[0.04, 0.04, 0.04], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[65.1,65.1,65.1], betaFail[0.053, 0.053,0.053], gammaFail[0.0203, 0.0203, 0.0203], peakFail[90.0])",
