...
import PhysicsTools.TagAndProbe.baseline.commonFitLoose_PH as common
...
DataBinningSpecification = cms.PSet(
    ...
    BinToPDFmap = cms.vstring(
        ...
        "loose_20p0To30p0_0p0To1p0", 
        #"loose_40p0To50p0_1p0To1p4442", 
        "*et_bin0*eta_bin0*","loose_20p0To30p0_M2p5ToM1p566",
        "*et_bin0*eta_bin1*","loose_20p0To30p0_M1p566ToM1p4442",
        "*et_bin0*eta_bin2*","loose_20p0To30p0_M1p4442ToM1p0",
        "*et_bin0*eta_bin3*","loose_20p0To30p0_M1p0To0p0",
        "*et_bin0*eta_bin4*","loose_20p0To30p0_0p0To1p0",
        "*et_bin0*eta_bin5*","loose_20p0To30p0_1p0To1p4442",
        "*et_bin0*eta_bin6*","loose_20p0To30p0_1p4442To1p566",
        "*et_bin0*eta_bin7*","loose_20p0To30p0_1p566To2p5",

        "*et_bin1*eta_bin0*","loose_30p0To40p0_M2p5ToM1p566",
        "*et_bin1*eta_bin1*","loose_30p0To40p0_M1p566ToM1p4442",
        "*et_bin1*eta_bin2*","loose_30p0To40p0_M1p4442ToM1p0",
        "*et_bin1*eta_bin3*","loose_30p0To40p0_M1p0To0p0",
        "*et_bin1*eta_bin4*","loose_30p0To40p0_0p0To1p0",
        "*et_bin1*eta_bin5*","loose_30p0To40p0_1p0To1p4442",
        "*et_bin1*eta_bin6*","loose_30p0To40p0_1p4442To1p566",
        "*et_bin1*eta_bin7*","loose_30p0To40p0_1p566To2p5",

        "*et_bin2*eta_bin0*","loose_40p0To50p0_M2p5ToM1p566",
        "*et_bin2*eta_bin1*","loose_40p0To50p0_M1p566ToM1p4442",
        "*et_bin2*eta_bin2*","loose_40p0To50p0_M1p4442ToM1p0",
        "*et_bin2*eta_bin3*","loose_40p0To50p0_M1p0To0p0",
        "*et_bin2*eta_bin4*","loose_40p0To50p0_0p0To1p0",
        "*et_bin2*eta_bin5*","loose_40p0To50p0_1p0To1p4442",
        "*et_bin2*eta_bin6*","loose_40p0To50p0_1p4442To1p566",
        "*et_bin2*eta_bin7*","loose_40p0To50p0_1p566To2p5",


        "*et_bin3*eta_bin0*","loose_50p0To200p0_M2p5ToM1p566",
        "*et_bin3*eta_bin1*","loose_50p0To200p0_M1p566ToM1p4442",
        "*et_bin3*eta_bin2*","loose_50p0To200p0_M1p4442ToM1p0",
        "*et_bin3*eta_bin3*","loose_50p0To200p0_M1p0To0p0",
        "*et_bin3*eta_bin4*","loose_50p0To200p0_0p0To1p0",
        "*et_bin3*eta_bin5*","loose_50p0To200p0_1p0To1p4442",
        "*et_bin3*eta_bin6*","loose_50p0To200p0_1p4442To1p566",
        "*et_bin3*eta_bin7*","loose_50p0To200p0_1p566To2p5",
        )
    )
...
McBinningSpecification = cms.PSet(
    ...
    BinToPDFmap = cms.vstring(
        "loose_20p0To40p0_0p0To1p5", 
        "*et_bin0*eta_bin0*","loose_20p0To40p0_0p0To1p5",
        "*et_bin1*eta_bin0*","loose_40p0To60p0_0p0To1p5",
        "*et_bin2*eta_bin0*","loose_60p0To100p0_0p0To1p5",
        "*et_bin0*eta_bin1*","loose_20p0To40p0_1p5To2p5",
        "*et_bin1*eta_bin1*","loose_40p0To60p0_1p5To2p5",
        "*et_bin2*eta_bin1*","loose_60p0To100p0_1p5To2p5",
        )
)
...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
        ...
        tag_Pho_mva = cms.vstring("Tag  MVA", "-10000", "10000", "")
        tag_Pho_et = cms.vstring("Tag  E_{T}", "20", "1000", "GeV/c"), ###new
        ),
        ...
        #MVAcut = cms.vstring("tag_Pho_mva","1","above")
        tagEt = cms.vstring("tag_Pho_et","35","above") ###new
        ),    
                                        ###SJ
                                        )
