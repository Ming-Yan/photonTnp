...
#import PhysicsTools.TagAndProbe.signalFitFunction.commonFitLoose_S as common
...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            #"RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[2.069,0.000,50.000],nP[0.444,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            #"RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[0.178,0.000,50.000],nF[0.376,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            "RooCBExGaussShape::signalResPass(mass,meanP[0.065,-5.000,5.000],sigmaP[2.693,0.000,15.000],alphaP[2.069,2.069,2.069],nP[0.444,0.444,0.444],sigmaP_2[1.137,0.500,15.000])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-2.361,-5.000,5.000],sigmaF[0.049,0.000,15.000],alphaF[0.178,0.178,0.178],nF[0.376,0.376,0.376],sigmaF_2[3.387,0.500,12.000])",
            "ZGeneratorLineShape::signalPhy(mass)", 
            "RooCMSShape::backgroundPass(mass, alphaPass[59,59,59], betaPass[0.0, 0.0,0.0], gammaPass[0.025, 0.025, 0.025], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[65.,65.,65], betaFail[0.052, 0.052,0.052], gammaFail[0.0203, 0.0203, 0.0203], peakFail[90.0])",
