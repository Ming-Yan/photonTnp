...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            #"RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[1.782,0.000,50.000],nP[0.612,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            #"RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[0.002,0.000,50.000],nF[0.487,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            ...
            "RooCMSShape::backgroundPass(mass, alphaPass[68.,68.,68.], betaPass[0.0, 0.0,0.0], gammaPass[0.04, 0.04, 0.04], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[61.8,61.8,61.8], betaFail[0.073, 0.073,0.073], gammaFail[0.033, 0.033, 0.033], peakFail[90.0])",
