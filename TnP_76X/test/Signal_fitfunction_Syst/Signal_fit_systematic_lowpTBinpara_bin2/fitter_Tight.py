...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[1.971,0.000,50.000],nP[0.460,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[0.176,0.000,50.000],nF[0.846,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            "ZGeneratorLineShape::signalPhy(mass)", 
            "RooCMSShape::backgroundPass(mass, alphaPass[70,70,70], betaPass[0.0, 0.0,0.0], gammaPass[0.04, 0.04, 0.04], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[62.2,62.2,62.2], betaFail[0.065, 0.065,0.065], gammaFail[0.0344, 0.0344, 0.0344], peakFail[90.0])",
