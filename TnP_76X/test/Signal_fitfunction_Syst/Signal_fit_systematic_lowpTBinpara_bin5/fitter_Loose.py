...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCBExGaussShape::signalResPass(mass,meanP[-0.0,-10.000,10.000],sigmaP[0.956,0.00,20.000],alphaP[1.823,0.000,50.000],nP[0.580,0.000,50.000],sigmaP_2[1.000,0.500,40.00])",
            "RooCBExGaussShape::signalResFail(mass,meanF[-0.0,-20.000,10.000],sigmaF[1,0.00,30.000],alphaF[0.057,0.000,50.000],nF[0.575,0.000,20.000],sigmaF_2[1.675,0.100,40.000])",
            "ZGeneratorLineShape::signalPhy(mass)", 
            "RooCMSShape::backgroundPass(mass, alphaPass[57,57,57], betaPass[0.06, 0.06,0.06], gammaPass[0.05, 0.05, 0.05], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[60.3,60.3,60.3], betaFail[0.1, 0.1,0.1], gammaFail[0.03, 0.03, 0.03], peakFail[90.0])",
