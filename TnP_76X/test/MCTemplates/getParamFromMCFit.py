...
def main(options):
    ...
    for binVar1 in xrange(len(var1s)-1):
        for binVar2 in xrange(len(var2s)-1):
            ...
            binName = options.var1Name +"_bin"+str(binVar1)+"__"+options.var2Name+"_bin"+str(binVar2)+"__pdfSignalPlusBackground"
...
if __name__ == "__main__":  
    ...
    parser.add_option("-o", "--outputFile", default="parametricTemplates.py", help="Output filename")
    ...
    parser.add_option("", "--var1Bins", default="20,30", help="Binning to use in var1")
    parser.add_option("", "--var2Bins", default="-2.5,-1.566,-1.4442,-1.0,0.0,1.0,1.4442,1.566,2.5", help="Binning to use in var2")
    parser.add_option("", "--var2Name", default="probe_sc_eta", help="Variable1 branch name")
    parser.add_option("", "--var1Name", default="probe_sc_et", help="Variable2 branch name")
