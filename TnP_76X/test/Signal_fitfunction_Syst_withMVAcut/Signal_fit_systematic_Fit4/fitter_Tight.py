...
process.TnPMeasurement = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
            ...
            "RooCMSShape::backgroundPass(mass, alphaPass[60.,50.,100.], betaPass[0.001, 0.,0.1], gammaPass[0.1, 0, 1], peakPass[90.0])",
            "RooCMSShape::backgroundFail(mass, alphaFail[60.,50.,100.], betaFail[0.001, 0.,0.1], gammaFail[0.1, 0, 1], peakFail[90.0])",
