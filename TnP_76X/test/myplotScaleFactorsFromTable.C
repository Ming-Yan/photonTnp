...
void savePlot(TH2F *h, string name, bool plotErr){
  ...
  */
  ...
  h->SetContour(20);
  h->SetContourLevel(0,0.50);
  h->SetContourLevel(1,0.55);
  h->SetContourLevel(2,0.60);
  h->SetContourLevel(3,0.65);
  h->SetContourLevel(4,0.70);
  h->SetContourLevel(5,0.80);
  h->SetContourLevel(6,0.90);
  h->SetContourLevel(7,0.91);
  h->SetContourLevel(8,0.92);
  h->SetContourLevel(9,0.93);
  h->SetContourLevel(10,0.94);
  h->SetContourLevel(11,0.95);
  h->SetContourLevel(12,0.955);
  h->SetContourLevel(13,0.96);
  h->SetContourLevel(14,0.965);
  h->SetContourLevel(15,0.97);
  h->SetContourLevel(16,0.975);
  h->SetContourLevel(17,0.98);
  h->SetContourLevel(18,0.985);
  h->SetContourLevel(19,1.00);
  ...
  Size=(fabs(HBond-LBond) / 20);

  // color region
  h->SetContour(20);
  h->SetContourLevel(0,0.5);
  h->SetContourLevel(1,LBond+Size*1);
  h->SetContourLevel(2,LBond+Size*2);
  h->SetContourLevel(3,LBond+Size*3);
  h->SetContourLevel(4,LBond+Size*4);
  h->SetContourLevel(5,LBond+Size*5);
  h->SetContourLevel(6,LBond+Size*6);
  h->SetContourLevel(7,LBond+Size*7);
  h->SetContourLevel(8,LBond+Size*8);
  h->SetContourLevel(9,LBond+Size*9);
  h->SetContourLevel(10,LBond+Size*10);
  h->SetContourLevel(11,LBond+Size*11);
  h->SetContourLevel(12,LBond+Size*12);
  h->SetContourLevel(13,LBond+Size*13);
  h->SetContourLevel(14,LBond+Size*14);
  h->SetContourLevel(15,LBond+Size*15);
  h->SetContourLevel(16,LBond+Size*16);
  h->SetContourLevel(17,LBond+Size*17);
  h->SetContourLevel(18,LBond+Size*18);
  h->SetContourLevel(19,LBond+Size*19);
  */
...
void myplotScaleFactorsFromTable(int type = 0){
  ...
  datafile.open( "passing"+file+"_Signal_mva.txt");
